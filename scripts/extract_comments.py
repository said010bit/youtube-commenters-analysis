    ...
    try:
        ...
        if response['items']:
            ...
            instagram_patterns = [
                ...
                r'@([a-zA-Z0-9_.]+)',  # Common Instagram mention format
                r'ig:\s*([a-zA-Z0-9_.]+)',  # "ig: username" format
                r'insta:\s*([a-zA-Z0-9_.]+)'  # "insta: username" format
            ]
        ...
        print(f"Error getting channel description: {e}")
